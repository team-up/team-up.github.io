define({ "api": [
  ...
  },
  {
      ...
      "fields": {
        ...
        "JSON": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "extras",
            "description": "<p>추가 정보 리스트<br><br>-- Bot --<br> version : 1, type : answer,<br>msg_buttons : Object[](메세지 버튼), input_buttons : Object[](입력 버튼)</p>"
          }
        ]
      },
      "examples": [
        ...
        {
          "title": "Bot Example",
          "content": "{\"content\":\"test\",\"extras\":[{\"version\":1,\"type\":\"answer\",\"msg_buttons\":[{\"text\":\"메세지 버튼\",\"type\":\"text\"},{\"text\": \"URL 메세지 버튼\",\"type\": \"url\",\"url\":\"https://tmup.com\"}],\"input_buttons\":[{\"text\":\"입력 버튼\",\"type\":\"text\"}]}]}",
          "type": "json"
        }
      ]
    },
    ...
    "description": "<ul> <li>피드 태그</li> </ul> <p>GET <a href=\"../feed/index.html#api-tag-GetTagFeed\">/v3/tag/feeds</a> 로 태그 가능 피드 번호 검색 후</p> <p>content 내용 중 태그 영역에 #{피드번호}</p> <p>tagfeeds 에 피드 번호 리스트 추가 (비어있을 경우 태그 처리 안됨)</p> <ul> <li>Bot 메세지</li> </ul> <p>Bot 관리자에서 등록된 Bot 계정만 extras의 Bot 메세지 사용 가능</p>",
    "error": {
      "fields": {
        "Error 4xx": [
          {
