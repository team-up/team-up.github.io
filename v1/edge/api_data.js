define({ "api": [
  {
    ...
    "name": "Authorization",
    "group": "Base",
    "filename": "c:/Users/vicious/workspace/logic/fpm/v1/apidoc.js",
    "groupTitle": "Base",
    "header": {
      "fields": {
        "": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "<p>string</p> ",
            "optional": false,
            "field": "file.upload_url",
            "description": "<p>업로드 url (POST <a href=\"#api-File-PostFiles\">/v1/files</a>)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "file.upload_max_size",
          ...
          },
          {
            ...
            "type": "<p>string</p> ",
            "optional": false,
            "field": "thumb.video_url",
            "description": "<p>동영상 썸네일 url (GET <a href=\"#api-File-GetThumbVideo\">/v1/thumb/video</a>)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>string</p> ",
            "optional": false,
            "field": "thumb.image_url",
            "description": "<p>이미지 썸네일 url (GET <a href=\"#api-File-GetThumbImage\">/v1/thumb/image</a>)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>object</p> ",
      ...
      "examples": [
        {
          ...
          "content": "{\n\"event\":{\n\"lp_url\":\"https:\\/\\/ev.tmup.com\\/v1\\/events\",\n\"lp_idle_time\":1,\n\"lp_wait_timeout\":30\n},\n\"file\":{\n\"upload_url\":\"https:\\/\\/file.tmup.com\\/v1\\/files\",\n\"upload_max_size\":100\n},\n\"thumb\"\"{\n\"video_url\":\"https:\\/\\/file.tmup.com\\/v1\\/thumb/video\",\n\"image_url\":\"https:\\/\\/file.tmup.com\\/v1\\/thumb/image\"\n},\n\"chat\":{\n\"room_max_usercount\":100,\n\"room_name_usercount\":10\n}\n}",
          "type": "json"
        }
      ]
    },
    "filename": "c:/Users/vicious/workspace/logic/fpm/v1/api/Get.php",
    "groupTitle": "Base"
  },
  {
    "type": "*",
      ...
      "examples": [
        {
          ...
          "content": "DELETE /v1/room/1/user1%2Cuser2 HTTP/1.1",
          "type": "json"
        }
      ]
    },
    "filename": "c:/Users/vicious/workspace/logic/fpm/v1/api/Delete.php",
    "groupTitle": "Chat",
    "success": {
      "fields": {
        "Success 2xx": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "len",
            "description": "<p>내용 길이 (장문 여부 판단 - content 글자 수와 다르면 장문)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>string</p> ",
  ...
  {
    "type": "get",
    "url": "/v1/room/files/:room/:count(/:way(/:type(/:start)))",
    "title": "대화방 파일 목록",
    "name": "GetRoomFiles",
    "group": "Chat",
    "version": "2.0.0",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success Example",
          "content": "{\n\"files\":[\n{\"file\":1,\"type\":1,\"name\":\"1.txt\",\"size\":1,\"w\":0,\"h\":0,\"msg\":1,\"user\":2,\"created\":1392319357}\n]\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/v1/room/files/count/:room(/:type)",
    "title": "대화방 파일 수",
    "name": "GetRoomFilesCount",
    "group": "Chat",
    "version": "2.0.0",
    "parameter": {
      "fields": {
      ...
      "fields": {
        ...
        "Query String": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "count",
            "description": "<p>검색 가져올 수 (검색 시 필수)</p> "
          },
          {
            "group": "Query String",
            "type": "<p>number</p> ",
            ...
            "field": "start",
            "defaultValue": "0",
            "description": "<p>검색 시작 수 (검색 시 사용)</p> "
          }
        ]
      },
      "examples": [
        {
          "title": "Example: 전체",
          "content": "GET /v1/rooms HTTP/1.1",
          "type": "json"
        },
        {
          "title": "Example: 검색",
          "content": "GET /v1/rooms?count=5&search=asdf HTTP/1.1",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "rooms.msgtype",
            "description": "<p>메시지 종류 (1:일반, 2:파일, 검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
          ...
          },
          {
            ...
            "description": "<p>안 읽은 메시지 수 (검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": true,
            "field": "rooms.newmsg",
            "description": "<p>안 읽은 메시지 번호 시작 (검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
  ...
  },
  {
    ...
    "filename": "c:/Users/vicious/workspace/logic/fpm/v1/api/Post.php",
    "groupTitle": "Chat",
    "error": {
      "fields": {
        "Error 4xx": [
  ...
  },
  {
      ...
      "fields": {
        ...
        "JSON": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "alert",
            "description": "<p>{0-1}] 알림 (0:사용안함, 1:사용)</p> "
          }
        ]
      },
      "examples": [
    ...
    "filename": "c:/Users/vicious/workspace/logic/fpm/v1/api/Put.php",
    "groupTitle": "Chat",
    "success": {
      "fields": {
        "Success 2xx": [
  ...
  {
    "type": "get",
    "url": "/v1/message/file/:room/:msg/:file",
    "title": "메시지 파일 다운로드",
    "name": "GetMessageFile",
    "group": "Chat_Message",
    "version": "2.0.0",
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Request Example: 최신 대화 목록",
          "content": "GET /v1/messages/1/10 HTTP/1.1",
          "type": "json"
        },
        {
          "title": "Request Example: 검색",
          "content": "GET /v1/messages/1/10?search=asdf HTTP/1.1",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "msgs.tagfeeds",
            "description": "<p>태그 피드번호 (|로 구분, 비어있으면 태그 없음, 검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
  ...
  {
    "type": "get",
    "url": "/v1/messages/count/:room/:msg",
    "title": "이후 메시지 수",
  ...
  {
    "type": "get",
    "url": "/v1/messages/status/:room(/:confirm)",
    "title": "메시지 읽음 상태",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "field": "confirm",
            "defaultValue": "1",
            "description": "<p>읽음 처리(0:안함, 1:모든 메시지 읽음)</p> "
          }
        ]
      }
    },
    "description": "<p>msgstart ~ msgend 범위 내 메시지들의 카운트 처리.</p> ",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  },
  {
    ...
    "group": "Chat_Message",
    "version": "2.0.0",
    "description": "<ul> <li>피드 태그</li> </ul> <p>/tag/feeds 로 태그 가능 피드 번호 검색 후</p> <p>content 내용 중 태그 영역에 #{피드번호}</p> <p>tagfeeds 에 피드 번호 리스트 추가 (비어있을 경우 태그 없는 것으로 처리)</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "description": "<p>읽음 상태 (0:전체, 1:읽은 알림만, type: inform.*)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            ...
            "description": "<p>지켜보기 (0:일반, 1:지켜보기, type: inform.*)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>object</p> ",
  ...
  },
  {
      ...
      "fields": {
        ...
        "Query String": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "filetype",
            "description": "<p>파일 정보 포함 종류 (filecount와 함께 사용, 0:전체, 1:일반, 2:이미지/동영상)</p> "
          },
          {
            "group": "Query String",
            "type": "<p>number</p> ",
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success Example",
          "content": "{\n\"team\":1,\n\"feedgroup\":1,\n\"groupname\":\"그룹1\",\n\"user\":4,\n\"type\":1,\n\"push\":0,\n\"len\":1,\n\"content\":\"글\",\n\"removable\":0,\n\"watch\":0,\n\"liked\":0,\n\"tagfeeds\":null,\n\"tagusers\":null,\n\"readcount\":1,\n\"replycount\":0,\n\"likecount\":0,\n\"filecount\":1,\n\"mediacount\":0,\n\"created\":1398221119,\n\"files\":[{\"file\":1,\"type\":1,\"name\":\"1.txt\",\"size\":1,\"w\":0,\"h\":0,\"created\":1398221118}]\n}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "success": {
      ...
      "examples": [
        {
          "title": "Success Example",
          "content": "{\n\"files\":[\n{\"file\":1,\"type\":1,\"name\":\"1.txt\",\"size\":1,\"w\":0,\"h\":0,\"created\":1398238682}\n]\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/v1/feed/summary/:feed(/:confirm)",
    "title": "피드 요약 정보",
    "name": "GetFeedSummary",
    "group": "Feed",
    "version": "2.0.0",
  ...
  },
  {
    ...
    "group": "Feed",
    "version": "2.0.0",
    "description": "<p>way=0 &amp; group 지정 시 해당 그룹의 모든 피드 알림이 읽음(status 2)으로 변경됨 (댓글/좋아요 제외)</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "examples": [
        ...
        {
          "title": "Request Example: 피드 그룹 페이지 검색",
          "content": "GET /v1/feeds/10?group=1&search=asdf HTTP/1.1",
          "type": "json"
        }
      ]
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "feeds.watch",
            "description": "<p>지켜보기 (0:안함, 1:사용, 검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": true,
            "field": "feeds.liked",
            "description": "<p>자신의 좋아요 여부 (0:안함, 1:함, 검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>string</p> ",
          ...
          },
          {
            ...
            "description": "<p>태그 유저번호 (|로 구분, 그룹 멤버만, 검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
          ...
          },
          {
            ...
            "description": "<p>전체 파일 수 (검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            ...
            "description": "<p>미디어 파일 수 (검색 시 제외)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Request Example: 뉴스피드",
          "content": "GET /v1/feeds/count/12704 HTTP/1.1",
          "type": "json"
        },
        {
          "title": "Request Example: 팀 페이지",
          "content": "GET /v1/feeds/count/12704?team=1 HTTP/1.1",
          "type": "json"
        },
        {
          "title": "Request Example: 피드 그룹 페이지",
          "content": "GET /v1/feeds/count/12704?group=1 HTTP/1.1",
          "type": "json"
        },
        {
          "title": "Request Example: 유저 페이지",
          "content": "GET /v1/feeds/count/12704?user=1 HTTP/1.1",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "filename": "c:/Users/vicious/workspace/logic/fpm/v1/api/Post.php",
    "groupTitle": "Feed",
    "description": "<ul> <li>사용자 태그</li> </ul> <p>/tag/users 로 태그 가능 사용자 검색 후</p> <p>content 내용 중 태그 영역에 @{사용자번호,사용자이름}</p> <p>tagusers 에 사용자 번호 리스트 추가 (서버에서 빠른 처리를 위해 사용, 비어있을 경우 태그 없는 것으로 간주)</p> <ul> <li>피드 태그</li> </ul> <p>/tag/feeds 로 태그 가능 피드 번호 검색 후</p> <p>content 내용 중 태그 영역에 #{피드번호}</p> <p>tagfeeds 에 피드 번호 리스트 추가 (비어있을 경우 태그 없는 것으로 간주)</p> "
  },
  {
    "type": "put",
    "url": "/v1/feed/:feed",
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Request Example",
          "content": "{\"content\":\"test @{4,유저4} #{1123}\",\"files\":[1,2],\"tagusers\":[4],\"tagfeeds\":[1123]}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "delete",
    "url": "/v1/feedgroup/user/:feedgroup(/:targetuser)",
    "title": "그룹 탈퇴",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "targetuser",
            "description": "<p>탈퇴 유저 번호 (강제 탈퇴 - 그룹 관리자 권한)</p> "
          }
        ]
      }
    },
  ...
  {
    "type": "delete",
    "url": "/v1/feedgroup/user/prepare/:feedgroup",
    "title": "그룹 탈퇴 상태 체크",
    "name": "DeleteFeedGroupUserPrepare",
    "group": "Feed_Group",
    "version": "2.0.0",
    "description": "<p>그룹 탈퇴 전에 그룹 멤버 상태 체크</p> ",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "needadmin",
            "description": "<p>관리자 지정 필요 여부 (0:필요없음, 1:필요)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "removegroup",
            "description": "<p>그룹 삭제 여부 (마지막 멤버인 경우, 0:다른 멤버 있음, 1:그룹 삭제)</p> "
          }
        ]
      },
      "examples": [
        {
          "title": "Success Example",
          "content": "{\"membertype\":1,\"needadmin\":0,\"removegroup\":0}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/v1/feedgroup/base/:feedgroup",
    "title": "그룹 기본 설정 정보",
    "name": "GetFeedGroupBase",
    "group": "Feed_Group",
    "version": "2.0.0",
    "permission": [
      {
        "name": "feedgroup admin"
      }
    ],
    "parameter": {
      "fields": {
    ...
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "write",
            "description": "<p>쓰기 권한 (1:멤버허용, 2:관리자만)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "remove",
            "description": "<p>삭제 권한 (1:멤버허용, 2:관리자만)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "replywrite",
            "description": "<p>댓글 쓰기 권한 (1:멤버허용, 2:관리자만)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "replyremove",
            "description": "<p>댓글 삭제 권한 (1:멤버허용, 2:관리자만)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
      ...
      "examples": [
        {
          "title": "Success Example",
          "content": "{\"groupname\":\"그룹1\",\"groupfile\":0,\"watchfeed\":0,\"write\":1,\"remove\":1,\"replywrite\":1,\"replyremove\":1,\"alerttype\":1,\"alertfeed\":0,\"alertreply\":0}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    ...
    "parameter": {
      ...
      "examples": [
        {
          "title": "Example: 전체",
          "content": "GET /v1/feedgroups HTTP/1.1",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "/v1/feedgroup/admins/:feedgroup",
    "title": "그룹 관리자 설정",
    "name": "PutFeedGroupAdmins",
    "group": "Feed_Group",
    "version": "2.0.0",
    "permission": [
      {
      ...
      "fields": {
        ...
        "JSON": [
          ...
          },
          {
            ...
            "optional": true,
            "field": "file",
            "description": "<p>이미지 파일 번호 (0이면 설정 안함)</p> "
          },
          {
            "group": "JSON",
            "type": "<p>number</p> ",
            ...
            "optional": true,
            "field": "watchfeed",
            "description": "<p>지켜보기 (0:안함, 1:사용) - 새 멤버 기본값으로 사용</p> "
          },
          {
            "group": "JSON",
            "type": "<p>number</p> ",
          ...
          },
          {
            ...
            "optional": true,
            "field": "alertfeed",
            "description": "<p>새글 알림 (0:사용안함, 1:사용) - 멤버허용일 경우 초대 시 기본값으로 사용</p> "
          },
          {
            "group": "JSON",
            "type": "<p>number</p> ",
            ...
            "optional": true,
            "field": "alertreply",
            "description": "<p>댓글 알림 (0:사용안함, 1:사용) - 멤버허용일 경우 초대 시 기본값으로 사용</p> "
          },
          {
            "group": "JSON",
            "type": "<p>number</p> ",
            ...
            "optional": true,
            "field": "write",
            "description": "<p>글 쓰기 권한 (1:멤버허용, 2:관리자만)</p> "
          },
          {
            "group": "JSON",
            "type": "<p>number</p> ",
            ...
            "optional": true,
            "field": "remove",
            "description": "<p>글 삭제 권한 (1:멤버허용, 2:관리자만)</p> "
          },
          {
            "group": "JSON",
            "type": "<p>number</p> ",
  ...
  {
    "type": "get",
    "url": "/v1/feed/likes/count/:feed",
    "title": "좋아요 수",
    "name": "GetFeedLikesCount",
    "group": "Feed_Like",
    "version": "2.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/v1/feed/replies/count/:feed(/:start)",
    "title": "댓글 수",
    "name": "GetFeedRepliesCount",
    "group": "Feed_Reply",
    "version": "2.0.0",
    "parameter": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/v1/feed/reply/summary/:feed/:reply",
    "title": "댓글 요약 정보",
  ...
  {
    "type": "get",
    "url": "https://file.tmup.com/v1/thumb/image/:file:/:width:/:height",
    "title": "이미지 썸네일",
    "name": "GetThumbImage",
    "group": "File",
    "version": "2.0.0",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "width",
            "description": "<p>가로 pixel (0이면 세로 비율에 맞춤)</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "height",
            "description": "<p>세로 pixel (0이면 가로 비율에 맞춤)</p> "
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "Content",
            "description": "<p>썸네일 스트림 (application/octet-stream 등)</p> "
          }
        ],
        "Success 3xx": [
          {
  ...
  {
    "type": "get",
    "url": "https://file.tmup.com/v1/thumb/video/:file:/:width:/:height",
    "title": "동영상 썸네일",
    "name": "GetThumbVideo",
    "group": "File",
    "version": "2.0.0",
  ...
  {
    "type": "post",
    "url": "https://file.tmup.com/v1/files/:team",
    "title": "파일 업로드",
    "name": "PostFiles",
    "group": "File",
    "version": "2.0.0",
    "description": "<p>이미지/동영상 썸네일 추출을 위해 form-data에 Content-Type 이 명시되어 있어야함 (전체 100M, 10개 제한)</p> ",
    "header": {
      "fields": {
        "Header": [
          {
    ...
    "parameter": {
      "fields": {
        ...
        "Content": [
          {
            "group": "Content",
            "type": "<p>multipart/form-data</p> ",
            "optional": false,
            "field": "files",
            "description": "<p>파일 데이터 리스트</p> "
          }
        ],
        "Content-Disposition": [
          {
    ...
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "files.file",
            "description": "<p>파일 번호 (업로드 성공 시)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
      ...
      "examples": [
        {
          "title": "Success Example",
          "content": "{\n\"files\":[\n{\"file\":2,\"type\":1,\"name\":\"a.txt\",\"w\":0,\"h\":0,\"size\":29},\n{\"file\":3,\"type\":2,\"name\":\"b.png\",\"w\":200,\"h\":100,\"size\":1932741}\n]\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "delete",
    "url": "/v1/inform/feeds/:watch(/:noti)",
    "title": "피드 알림 삭제",
    "version": "2.0.0",
    "name": "DeleteInformFeeds",
    "group": "Inform",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "watch",
            "description": "<p>지켜보기 (0:일반, 1:지켜보기)</p> "
          },
          {
            "group": "Parameter",
            "type": "<p>number</p> ",
        ...
        "Query String": [
          {
            ...
            "field": "read",
            "defaultValue": "0",
            "description": "<p>읽음 상태 (0:전체, 1:읽은 알림만)</p> "
          }
        ]
      },
      "examples": [
        {
          "title": "Example: 알림 하나 삭제",
          "content": "DELETE /v1/inform/feeds/0/1234 HTTP/1.1",
          "type": "json"
        },
        {
          "title": "Example: 읽은 알림 모두 삭제",
          "content": "DELETE /v1/inform/feeds/0?read=1 HTTP/1.1",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/v1/inform/feeds/:watch/:count(/:way(/:start))",
    "title": "피드 알림 목록",
    "name": "GetInformFeeds",
    "group": "Inform",
    "version": "2.0.0",
    ...
    "description": "<p>watch=0 &amp; way=0|2 호출 시 모든 일반 알림 확인(status 1)으로 변경됨</p> ",
    "success": {
      "fields": {
        "Success 200": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "notis.type",
            "description": "<p>알림 종류 (feed:피드, reply:댓글, like:좋아요, tagfeed:태그피드, tagreply:태그댓글, join:가입, exit:강제탙퇴, admin:관리자, rename:이름변경, watch:지켜보기시작)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "notis.status",
            "description": "<p>상태 (0:읽지 않음, 1:확인, 2:읽음)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
          ...
          },
          {
            ...
            "optional": false,
            "field": "notis.content",
            "description": "<p>내용 (type:rename - 이전 그룹 이름, type:admin - join|exit)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "notis.joincount",
            "description": "<p>참여 유저 수 (type:reply|like|tagreply)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
          ...
          },
          {
            ...
            "optional": false,
            "field": "notis.push",
            "description": "<p>강제 알림 (0:안함, 1:사용, type:feed|tagfeed)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "notis.feeduser",
            "description": "<p>피드 유저 번호 (type:reply|like|tagreply)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
            "optional": false,
            "field": "notis.feedlen",
            "description": "<p>피드 내용 길이 (장문 여부 판단 - content 글자 수와 다르면 장문)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>string</p> ",
            "optional": false,
            "field": "notis.feedcontent",
            "description": "<p>피드 내용 (type:reply|like|tagreply)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
  ...
  {
    "type": "get",
    "url": "/v1/inform/feeds/count/:watch/:start",
    "title": "피드 알림 수",
    "name": "GetInformFeedsCount",
    "group": "Inform",
    "version": "2.0.0",
    "parameter": {
      "fields": {
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "field": "type",
            "defaultValue": "15",
            "description": "<p>알림 종류 (1:채팅, 2:그룹 피드, 4:피드 알림, 8:지켜보기 알림, OR 연산으로 필요한 것만 조회)</p> "
          }
        ]
      }
    },
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "newsgroup",
            "description": "<p>그룹 피드 알림 수 (글,댓글,좋아요,그룹설정 등 모두)</p> "
          },
          {
            "group": "Success 200",
            "type": "<p>number</p> ",
      ...
      "examples": [
        {
          "title": "Success Example",
          "content": "{\"chat\":10,\"newsgroup\":2,\"informfeed\":1,\"informwatch\":0}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "put",
    "url": "/v1/inform/feed/reset/:noti",
    "title": "피드 지켜보기 알림 읽음 해제",
    "name": "PutInformFeed",
    "group": "Inform",
    "version": "2.0.0",
    "parameter": {
  ...
  {
    "type": "get",
    "url": "/v1/tag/users/:feedgroup/:count/:start/:search",
    "title": "@태그 (유저)",
    "name": "GetTagUser",
    "group": "Tag",
    "version": "2.0.0",
